...
class news_magazine_updater extends WDWT_updater{
 ...
 '1.0.50' => array(
       ...
       array('old'=> "news_magazinety_type_inputs_style", 'new'=>'text_inputs_style' , 'type'=>'select_to_select_array'),
		...
		array('old'=> "news_magazinecc_slider_back_color", 'new'=>'slider_back_color' , 'type'=>'get_old_colors', 'args'=>array('default'=>"#FFFFFF")),
		...
		array('old'=> "news_magazinecc_primary_text_color", 'new'=>'primary_text_color' , 'type'=>'get_old_colors', 'args'=>array('default'=>"#838383")),
		...
		array('old'=> "news_magazinecc_menu_links_color", 'new'=>'menu_links_color' , 'type'=>'get_old_colors', 'args'=>array('default'=>"#838383")),
		...
		array('old'=> "news_magazinecc_logo_text_color", 'new'=>'logo_text_color' , 'type'=>'get_old_colors', 'args'=>array('default'=>"#0977A4")),
 ...
 */
  ...
  */
  ...
  protected function get_old_colors( $val, $param_name, $args=array()){
	...
	$this->options['color_scheme']['colors'][0]['lightbox_bg_color'] = array('value' => "#CCCCCC",'default' =>"#CCCCCC");
    ...
    $this->options['color_scheme']['colors'][1]=array(
		...
		"primary_text_headers_color"               =>array('value' => "#F32241", 'default' =>"#F32241"),                
		...
		"primary_links_hover_color"        =>array('value' => "#F32241", 'default' =>"#F32241"),                
		...
		"logo_text_color"          =>array('value' => "#F32241", 'default' =>"#F32241"),                
