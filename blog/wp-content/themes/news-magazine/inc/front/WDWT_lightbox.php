    ...
    <div class="wdwt_image_wrap">
      ...
      <div class="wdwt_btn_container">
        <div class="wdwt_ctrl_btn_container">
          ...
          ?>
          <i title="<?php esc_attr_e('Maximize', "news-magazine"); ?>" class="wdwt_ctrl_btn wdwt_resize-full fa fa-resize-full "></i>
          <?php
          }
          ?>
          <i title="<?php echo esc_attr_e('Fullscreen', "news-magazine"); ?>" class="wdwt_ctrl_btn wdwt_fullscreen fa fa-fullscreen"></i>
          <?php } 
          if ($popup_enable_info) { ?>
          <i title="<?php echo esc_attr_e('Show info', "news-magazine"); ?>" class="wdwt_ctrl_btn wdwt_info fa fa-info"></i>
          <?php
          }
          if ($popup_enable_fullsize_image) {
            ?>
            <a id="wdwt_fullsize_image" href="<?php echo $current_image_url; ?>" target="_blank">
              <i title="<?php echo esc_attr_e('Open image in original size.', "news-magazine"); ?>" class="wdwt_ctrl_btn fa fa-external-link"></i>
            </a>
            <?php
          }
          ?>
