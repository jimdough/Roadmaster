  ...
  public function head_advertisment(){
    ...
    $integration_head_advertisment_title = esc_attr(stripslashes($this->get_param('integration_head_advertisment_title')));
      ...
      case 'adsens': 
        ...
        break;
      case 'advertisment': 
        ?><div class="advertismnet" id="top-advertismnet"><a href="<?php echo $integration_head_advertisment_url ?>"><img src="<?php echo $integration_head_advertisment_picture; ?>" alt="<?php echo $integration_head_advertisment_alt; ?>" title="<?php echo $integration_head_advertisment_title; ?>" /></a></div><?php 
        break;
      default :
        /*none*/ 
      }
  ...
  protected function typography_fonts(){
    ...
    ?>
      @font-face { 
        ...
        src: url("<?php echo get_template_directory_uri(); ?>/inc/fonts/OpenSans-Bold.ttf");
        font-weight:bold;
      }
      @font-face {
        font-family: "OpenSans";
        src: url("<?php echo get_template_directory_uri(); ?>/inc/fonts/OpenSans-BoldItalic.ttf");
        font-weight:bold;
        font-style:italic;
      }
      @font-face {
        font-family: "OpenSans";
        src: url("<?php echo get_template_directory_uri(); ?>/inc/fonts/OpenSans-ExtraBold.ttf");
        font-weight:bolder;
      }
      @font-face {
        font-family: "OpenSans";
        src: url("<?php echo get_template_directory_uri(); ?>/inc/fonts/OpenSans-ExtraBoldItalic.ttf");
        font-weight:bolder;
        font-style:italic;  
      }
      @font-face {
        font-family: "OpenSans";
        src: url("<?php echo get_template_directory_uri(); ?>/inc/fonts/OpenSans-Italic.ttf");
        font-style:italic;
      }
      @font-face {
        font-family: "OpenSans";
        src: url("<?php echo get_template_directory_uri(); ?>/inc/fonts/OpenSans-Light.ttf");
        font-weight:lighter;
      }
      @font-face {
        font-family: "OpenSans";
        src: url("<?php echo get_template_directory_uri(); ?>/inc/fonts/OpenSans-LightItalic.ttf");
        font-weight:lighter;
        font-style:italic;
      }
      @font-face {
        font-family: "OpenSans";
        src: url("<?php echo get_template_directory_uri(); ?>/inc/fonts/OpenSans-Regular.ttf"); 
      }
      @font-face {
        font-family: "OpenSans";
        src: url("<?php echo get_template_directory_uri(); ?>/inc/fonts/OpenSans-Semibold.ttf");
        font-weight:500;
      }
      @font-face {
        font-family: "OpenSans";
        src: url("<?php echo get_template_directory_uri(); ?>/inc/fonts/OpenSans-SemiboldItalic.ttf");
        font-weight:500;
        font-style:italic;
      }
    <?php
