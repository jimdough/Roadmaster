...
class news_magazine_adv extends WP_Widget
{
    function __construct(){
		$widget_ops = array('description' => __( 'Displays Advertisements', "news-magazine" ));
    ...
    function form($instance){
		...
		.Remove_Banner{
			...
			?>
				...
				<legend align="left"><?php echo __('Banner',"news-magazine"); ?> <?php echo $key ?></legend>
				<div class="Remove_Banner" style="display: block; float: right; margin-top: -30px; background-color: inherit; padding: 0 5px;" onclick="remove_element(this)"><?php echo __('Remove',"news-magazine"); ?></div>
				<p><label for="<?php echo $this->get_field_id('bannerPath') ?>_<?php echo $key ?>"><?php echo __('Path',"news-magazine"); ?></label><br /><input abstype='path' class="widefat banner_path" onchange="create_inputs(this)"  id="<?php echo $this->get_field_id('bannerPath')?>_<?php echo $key ?>" name="<?php echo  $this->get_field_name('bannerPath')?>_<?php echo $key ?>" type="text" value="<?php echo $value ?>" />
				<p><label for="<?php echo $this->get_field_id('bannerUrl') ?>_<?php echo $key ?>"><?php echo __('Url',"news-magazine"); ?></label><br /><input abstype='url' class="widefat banner_url" onchange="create_inputs(this)" id="<?php echo $this->get_field_id('bannerUrl')?>_<?php echo $key ?>" name="<?php echo  $this->get_field_name('bannerPath')?>_<?php echo $key ?>" type="text" value="<?php echo $bannerUrl[$key]; ?>" />
				<p><label for="<?php echo $this->get_field_id('bannerTitle') ?>_<?php echo $key ?>"><?php echo __('Title',"news-magazine"); ?></label><br /><input abstype='title' class="widefat banner_title" onchange="create_inputs(this)" id="<?php echo $this->get_field_id('bannerTitle'); ?>_<?php echo $key ?>" name="<?php echo  $this->get_field_name('bannerPath'); ?>_<?php echo $key ?>" type="text" value="<?php echo $bannerTitle[$key]; ?>" />
				<p><label for="<?php echo $this->get_field_id('bannerAlt') ?>_<?php echo $key ?>"><?php echo __('Alt',"news-magazine"); ?></label><br /><input abstype='alt' class="widefat banner_alt" onchange="create_inputs(this)" id="<?php echo $this->get_field_id('bannerAlt')?>_<?php echo $key ?>" name="<?php echo  $this->get_field_name('bannerPath')?>_<?php echo $key ?>" type="text" value="<?php echo $bannerAlt[$key]; ?>" />
				</fieldset>
			
			<?php }}else {?>
				<fieldset id="1">
				<legend align="left"><?php echo __('Banner 1',"news-magazine"); ?></legend>
				<div class="Remove_Banner" style="display: block; float: right; margin-top: -30px; background-color: inherit; padding: 0 5px;" onclick="remove_element(this)"><?php echo __('Remove',"news-magazine"); ?></div>
				<p><label for="<?php echo $this->get_field_id('bannerPath') ?>_1"><?php echo __('Path',"news-magazine"); ?></label><br /><input abstype='path' class="widefat banner_path" onchange="create_inputs(this)"  id="<?php echo $this->get_field_id('bannerPath')?>_1" name="<?php echo  $this->get_field_name('bannerPath')?>_1" type="text" value="" />
				<p><label for="<?php echo $this->get_field_id('bannerUrl') ?>_1"><?php echo __('Url',"news-magazine"); ?></label><br /><input abstype='url' class="widefat banner_url" onchange="create_inputs(this)" id="<?php echo $this->get_field_id('bannerUrl')?>_1" name="<?php echo  $this->get_field_name('bannerPath')?>_1" type="text" value="" />
				<p><label for="<?php echo $this->get_field_id('bannerTitle') ?>_1"><?php echo __('Title',"news-magazine"); ?></label><br /><input abstype='title' class="widefat banner_title" onchange="create_inputs(this)" id="<?php echo $this->get_field_id('bannerTitle'); ?>_1" name="<?php echo  $this->get_field_name('bannerPath'); ?>_1" type="text" value="" />
				<p><label for="<?php echo $this->get_field_id('bannerAlt') ?>_1"><?php echo __('Alt',"news-magazine"); ?></label><br /><input abstype='alt' class="widefat banner_alt" onchange="create_inputs(this)" id="<?php echo $this->get_field_id('bannerAlt')?>_1" name="<?php echo  $this->get_field_name('bannerPath')?>_1" type="text" value="" />
				</fieldset>
				<?php  } ?>
				<input type="button" onclick="add_banner(this)" value="<?php echo __('Add Banner',"news-magazine"); ?>" />
