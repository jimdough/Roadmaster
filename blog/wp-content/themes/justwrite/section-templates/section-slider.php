...
/* <![CDATA[ */
	(function( $ ) { $( document ).ready(function() {
		...
		$('.ss-next-<?php echo absint( $wnum ); ?>').click(function() { event.preventDefault(); owl<?php echo absint( $wnum ); ?>.trigger('next.owl.carousel', [200]); });
		$('.ss-prev-<?php echo absint( $wnum ); ?>').click(function() { event.preventDefault(); owl<?php echo absint( $wnum ); ?>.trigger('prev.owl.carousel', [200]); });
	});})(jQuery);
/* ]]> */
</script>