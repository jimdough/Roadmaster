...
<div id="nav-single" class="pull-right"> 
                        <?php previous_image_link( '%link', '<span class="meta-nav"><i class="fa fa-white icon-chevron-left"></i></span> Previous'); ?>
                        <?php next_image_link( '%link', 'Next <span class="meta-nav"><i class="fa fa-white icon-chevron-right"></i></span>' ); ?>
</div>
