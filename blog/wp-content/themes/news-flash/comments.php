	...
	<?php if ( have_comments() ) : ?>
		...
		<ul class="commentlist">
			<?php
				 ...
				 * to use newsflash_comment() to format the comments.
				 * If you want to overload this in a child theme then you can
				 * define newsflash_comment() and that will be used instead.
				 * See newsflash_comment() in news-flash/functions.php for more.
				 */
				wp_list_comments(array('callback'=>'newsflash_comment','avatar_size'=>64, 'reply_text'=>'Reply'));
			?>
		</ul>
