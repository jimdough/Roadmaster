 ...
 <nav class="tab-bar">
  ...
  <aside class="right-off-canvas-menu">
   ...
   <div class="row center">
	   <img class="editable" width="100%" data-interchange="[img/headers/ph_choice-s.jpg, (default)], [img/headers/ph_choice-m.jpg, (medium)], [img/headers/ph_choice-l.jpg, (large)]" alt="Class A CDL License Training and Truck Driving Classes" id="untitled-region-1">
   </div>
...
<div class="panel radius editable" id="untitled-region-2">
