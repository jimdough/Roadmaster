 ...
 <nav class="tab-bar">
  ...
  <aside class="right-off-canvas-menu">
   ...
   <!-- END Small Nav -->
		...
		<div class="row">
	  <!-- Column #1 -->
	  <div class="small-12 medium-12 large-12 columns editable" id="row-col1">
	  		<!-- Column 1 Content goes here -->
	  <section> <!-- Left Side Content -->	  
<div class="row" id="hpForm"><?php include("inc/small-call.inc"); ?>		<div class="panel radius editable">
			<?php include("inc/form-test.php"); ?>
		</div>
</div>
	  </section>

<h2>Call Us</h2>
<p>We can be reached Toll Free at 1-800-831-1300</p>

<h2>Email Us</h2>
<p>We can be reached for customer service issues by <a href="mailto:4004091@tickets.livechatinc.com">email by clicking here</a>. Please use the form below to submit your application. This email goes to a different department.</p>
...
<div class="hide-for-small">
	<h2>Chat with Us</h2>
	<p><div data-id="392eb1baad" class="livechat_button"><a href="http://www.livechatinc.com/?partner=lc_4004091&amp;utm_source=chat_button">live chat software</a></div></p>
</div>
  ...
  <a class="exit-off-canvas"></a><?php include("inc/quick-nav.inc"); ?><?php include("inc/kudos.php"); ?>
