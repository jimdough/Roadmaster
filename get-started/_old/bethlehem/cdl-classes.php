...
<html class="no-js" lang="en" >
 ...
 <title>CDL Classes in Bethlehem, Pennsylvania - Roadmaster</title>
<meta name="DESCRIPTION" content="Roadmaster of Pennsylvania is a hands-on truck driving school and provides CDL classes for areas around Bethlehem, PA.">
...
<div class="row">
	<div class="column small-12 large-12 medium-12 editable" id="untitled-region-1"><h1>CDL Classes available in Bethlehem, Pennsylvania</h1>
...
<p>A career as a truck driver can offer an individual a way to go from unemployed or underemployed to a middle class lifestyle quickly. Truck driving is not just a job, it is a career and lifestyle. First year drivers average $40,000 to $45,000 their first year.* And that is just the beginning to what a truck driver can earn!</p>
<ul class="yes-bullet">
...
<h2>Roadmaster's CDL Classes in Bethlehem, Pennsylvania offer:</h2>
<p>Roadmaster has administrative offices, spacious classrooms, and computer labs where you will attend CDL classes in Pennsylvania. Our Bethlehem school maintains specially designed driving courses where students practice backing, coupling, uncoupling, and docking tractor trailers.</p>
<p>Our truck driving school in Bethlehem, Pennsylvania owns a fleet of late model tractor-trailers used exclusively for student CDL training and provides equipment for Commercial Driver License (Class A CDL license) testing at all locations.</p>
<ul class="yes-bullet">
<li>Comprehensive &amp; hands-on CDL classes in Bethlehem, PA</li>
...
<li>3-4 weeks of CDL classes that focus on Class A CDL license exam preparation</li>
<li>11 CDL training locations nationwide</li>
<li>Financial assistance for those who qualify</li>
  ...
  <!-- Row 3 -->
      <div class="row">
  	  <div class="large-6 columns editable" id="untitled-region-4"><h2>Roadmaster of Bethlehem,Pennsylvania</h2>
<p>Becoming a truck driver is possible with the right CDL classes behind you. With a solid reputation in the field, Roadmaster Drivers School in Bethlehem, Pennsylvania can help you become a professional truck driver with only 4 weeks of specialized hands-on CDL classes. For over 20 years, Roadmaster has trained over 60,000 entry-level drivers and continues to help put people to work every day!</p>
<p>Offering 11 CDL training locations across the country, Roadmaster is an industry leader in CDL classes, employing experienced instructors and offering students comprehensive classroom and behind-the-wheel truck driving education so they are fully prepared to start their new job in the trucking industry. By focusing on giving students the best education and maintaining high job placement standards, Roadmaster has gained an excellent reputation in the trucking industry for quality training of entry-level commercial truck drivers.</p>
<p>At Roadmaster, you will gain the confidence and know-how needed to enter into the professional trucking industry, setting yourself apart from the rest. Roadmaster is serious when it comes to helping graduates find a job and begins job placement assistance in the first week of classes. If qualified, you could even be pre-hired with a trucking company during your first week of training at Roadmaster! Many graduates receive multiple offers of employment from major transportation carriers such as Werner, Schneider, TMC, Covenant, Swift and more! Check out all of the exciting options by stopping by our truck driving school in Bethlehem, Pennsylvania.</p></div><!-- end column-->
...
<div class="columns small-12 medium-5" style="padding: 0; margin: 0;"><a class="hide-for-small button default round" style="padding: .5em; margin: .5em;" href="../../truck_school_Bethlehem_Pennsylvania.php#viewmap" target="_blank">Get Directions <i class="fi-arrow-right"></i></a></div></div>
	    ...
	    <div class="row">
			 <div class="columns editable" id="dynamic-disclaimer"><p class="small-disclaimer"><span class="s1"><b><i>*wage info supplied by Werner Enterprises</i></b></span></p></div>
		 </div>
...
<!-- CTA--><div class="row hide-for-small uneditable text-center" id="apply-headline"><div class="columns small-12"><h2>Call our Admissions Office Today at <b>1-800-831-1300</b> or fill out the form below to get started!</h2></div></div><br>			
		 </div> <!-- End Column 2-->
