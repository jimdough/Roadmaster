...
<html class="no-js" lang="en" >
 <head>
  ...
  <title>CDL Training in West Memphis, Arkansas - Roadmaster</title>
...
<h2>Roadmaster's Arkansas CDL training has the the following:</h2>
<p>Roadmaster has administrative offices, spacious classrooms, and computer labs where you will attend CDL training in Arkansas. The school maintains specially designed driving courses where students practice backing, coupling, uncoupling, and docking tractor trailers.</p>
<p>Roadmaster owns a fleet of late model tractor-trailers used exclusively for student training and provides equipment for Commercial Driver License (Class A AR CDL license) testing at all locations.</p>
<ul class="yes-bullet">
<li>Comprehensive &amp; hands-on CDL training in West Memphis, AR</li>
...
<!--Content 3-->
      <div class="row">
  	  <div class="large-6 columns editable" id="untitled-region-4"><h2>Why choose Roadmaster CDL Training in West Memphis, AR?</h2>
<p>Becoming a truck driver is possible with the right driver CDL school behind you. With a solid reputation in the field, Roadmaster Drivers School can help you become a professional truck driver with only 4 weeks of specialized hands-on CDL training in Arkansas. For over 20 years, Roadmaster has trained over 75,000 entry-level drivers and continues to help put people to work every day!</p>
