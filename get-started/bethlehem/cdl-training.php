...
<p>A career as a truck driver can offer an individual a way to go from unemployed or underemployed to a middle class lifestyle quickly. Truck driving is not just a job, it is a career and lifestyle. <span class="s1">First year drivers average $40,000 to $45,000 their first year.* And</span> but that is just the beginning to what a truck driver can earn!</p>
<ul class="yes-bullet">
...
<h2>Roadmaster's Pennsylvania CDL training has the the following:</h2>
<p>Roadmaster has administrative offices, spacious classrooms, and computer labs where you will attend CDL training in Pennsylvania. The school maintains specially designed driving courses where students practice backing, coupling, uncoupling, and docking tractor trailers.</p>
...
<ul class="yes-bullet">
<li>Comprehensive &amp; hands-on CDL training in Bethlehem, PA</li>
...
<li>12 CDL training nationwide</li>
...
<!--Content 3-->
      <div class="row">
  	  <div class="large-6 columns editable" id="untitled-region-4"><h2>Why choose Roadmaster CDL Training in Bethlehem,PA?</h2>
<p>Becoming a truck driver is possible with the right CDL school behind you. With a solid reputation in the field, Roadmaster Drivers School can help you become a professional truck driver with only 4 weeks of specialized hands-on CDL training in Pennsylvania. For over 20 years, Roadmaster has trained over 60,000 entry-level drivers and continues to help put people to work every day!</p>
