...
<html class="no-js" lang="en" >
 <head>
  ...
  <title>Pennsylvania CDL License - Roadmaster</title>
<meta name="DESCRIPTION" content="Roadmaster of Pennsylvania is a hands-on truck driving school & CDL License training center for areas around Bethlehem, PA.">
...
<img src="http://www.roadmaster.com/img/headers/school-bp-l.jpg" />
   </div>
...
<!--Content 2--> 
	<div class="row">
		<div class="column small-12 large-6 medium-12 editable" id="untitled-region-2"><div class="panel">
<h2>Truck Driver Salary &amp; Benefits</h2>
<p>A career as a truck driver can offer an individual a way to go from unemployed or underemployed to a middle class lifestyle quickly. Truck driving is not just a job, it is a career and lifestyle. <span class="s1">First year drivers average $40,000 to $45,000 their first year.* And</span> that is just the beginning to what a truck driver can earn!</p>
<ul class="yes-bullet">
...
<li>Team Driving allows couples and friends to drive in shifts to earn more money</li>
		 ...
		 <div class="large-6 columns editable" id="untitled-region-3"><div class="panel radius">
<h2>Roadmaster's Pennsylvania Truck Driving training has the the following:</h2>
<p>Roadmaster has administrative offices, spacious classrooms, and computer labs where you will attend truck driving training in Pennsylvania. The training center maintains specially designed driving courses where students practice backing, coupling, uncoupling, and docking tractor trailers.</p>
<p>Roadmaster owns a fleet of late model tractor-trailers used exclusively for student truck driver training and provides equipment for Commercial Driver License (Class A CDL license) testing at all locations.</p>
<ul class="yes-bullet">
<li>Comprehensive &amp; hands-on truck driving training in Bethlehem, PA</li>
<li>Top-notch practice equipment, facilities and instructors</li>
<li>You may be pre-hired by on-site recruiters before finishing truck driver training if qualified</li>
<li>Job placement assistance</li>
<li>4 weeks of classes that focus on CDL training and Pennsylvania Class A CDL license exam preparation</li>
<li>12 truck driving training schools nationwide</li>
...
<!--Content 3-->
      <div class="row">
  	  <div class="large-6 columns editable" id="untitled-region-4"><h2>Why choose Roadmaster Truck Driving Training in Bethlehem,PA?</h2>
<p>Becoming a truck driver is possible with the right driver training behind you. With a solid reputation in the field, Roadmaster Drivers School can help you become a professional truck driver with only 4 weeks of specialized hands-on truck driver training in Pennsylvania. For over 20 years, Roadmaster has trained over 60,000 entry-level truck drivers and continues to help put people to work every day!</p>
<p>Offering 12 truck driving training locations across the country, Roadmaster is an industry leader in truck driver training schools, employing experienced instructors and offering students comprehensive classroom and behind-the-wheel truck driving education so they are fully prepared to start their new job in the trucking industry. By focusing on giving students the best education and maintaining high job placement standards, Roadmaster has gained an excellent reputation in the trucking industry for quality training of entry-level commercial truck drivers.</p>
...
<!--Content 4-->
	  ...
	  <div class="large-6 columns editable" id="untitled-region-5"><h2>Location Information</h2>
<p><img src="../../img/cities/bpa5.jpg" alt="Roadmaster Truck Driving School"></p>
<div class="columns small-12 medium-7">
<p><b><a href="../../truck_school_Bethlehem_Pennsylvania.php">Roadmaster Drivers School of Bethlehem, Pennsylvania</a></b><br> 4219 Fritch Drive<br> Bethlehem, PA 18020<br> <a href="tel:+16103651037">Phone: (610) 365-1037</a> <span class="show-for-small"><a href="../../truck_school_Bethlehem_Pennsylvania.php#viewmap" target="_blank">Get Directions</a></span></p>
</div>
<div class="columns small-12 medium-5" style="padding: 0; margin: 0;"><a class="hide-for-small button default round" style="padding: .5em; margin: .5em;" href="../../truck_school_Bethlehem_Pennsylvania.php#viewmap" target="_blank">Get Directions <i class="fi-arrow-right"></i></a></div></div>
	   </div><!-- end row-->	
	   	  	<div class="row">
			 <div class="coluimns editable" id="dynamic-disclaimer"><p class="small-disclaimer"><span class="s1">*wage info supplied by Werner Enterprises </span></p></div>
		 </div>
...
<!-- CTA--><div class="row hide-for-small uneditable text-center" id="apply"><div class="columns small-12"><h2>Call our Admissions Office Today at <b>1-800-831-1300</b> or fill out the form below to get started!</h2></div></div><br>			
		  ...
		  <div class="editable" id="dynamnic-disclaimer"></div>
  	  		...
  	  		<p>Call us at 1-800-831-1300 or fill out the brief form below to submit your information to our CDL Classes admissions center. A Roadmaster representative will review your information and contact you to answer all of your questions and set up a date for you to visit the school location nearest you.</p>
   	  		...
   	  		<div id="form">
					...
					<!-- Organization ID-->	  	  		
		  	  		...
		  	  		<!-- Parent Campaign ID-->
		  	  		 <input name="00Nj00000095OEC" type="hidden" value="701m0000000A39wAAC" /> 
