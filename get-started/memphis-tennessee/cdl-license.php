...
<html class="no-js" lang="en" >
 <head>
  ...
  <title>Tennessee CDL License - Roadmaster</title>
...
<h2>Roadmaster offers Tennessee CDL License training with the following:</h2>
<p>Roadmaster has administrative offices, spacious classrooms, and computer labs where you will attend TN CDL license training in Tennessee. The school maintains specially designed driving courses where students practice backing, coupling, uncoupling, and docking tractor trailers.</p>
...
<ul class="yes-bullet">
<li>Comprehensive &amp; hands-on CDL license training in Memphis, TN</li>
...
<li>3-4 weeks of classes that focus on CDL training and Tennessee Class A CDL license exam preparation</li>
...
<!-- CTA--><div class="row show-for-small uneditable" id="apply"><div class="columns text-center"><a class="button success radius" href="tel:+18008311300" onclick="goog_report_conversion('tel:18008311300')">Click to Call Admissions Office<br>1-800-831-1300</a></div></div><!-- / CTA -->
 ...
 <!--Content 3-->
      <div class="row">
  	  <div class="large-6 columns editable" id="untitled-region-2"><h2>Why choose Roadmaster of Memphis, TN?</h2>
<p>Becoming a truck driver is possible with the right CDL classes behind you. With a solid reputation in the field, Roadmaster Drivers School can help you become a professional truck driver with only 3 to 4 weeks of specialized hands-on training while getting your CDL in Memphis, TN. For over 20 years, Roadmaster has trained over 75,000 entry-level drivers and continues to help put people to work every day!</p>
