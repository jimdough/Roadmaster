...
<html class="no-js" lang="en" >
 <head>
  ...
  <title>Truck Driving School in city, state - Roadmaster</title>
<meta name="DESCRIPTION" content="Roadmaster of state is a hands-on truck driving school & CDL License training center for areas around city, abbrev.">
...
<img src="http://www.roadmaster.com/img/headers/school-header.jpg" />
   </div>
...
<h2>Roadmaster's truck driving school state has the following:</h2>
<p>Roadmaster has administrative offices, spacious classrooms, and computer labs where you will attend truck driving school in state. The school maintains specially designed driving courses where students practice backing, coupling, uncoupling, and docking tractor trailers.</p>
...
<ul class="yes-bullet">
<li>Comprehensive &amp; hands-on truck driving school in city, abbrev</li>
...
<li>4 weeks of classes that focus on CDL training and state Class A CDL license exam preparation</li>
...
<p><img src="../../img/cities/school-image.jpg" alt="Roadmaster Truck Driving School"></p>
<div class="columns small-12 medium-7">
<p><b><a href="../../truck_school_city_state.php">Roadmaster Drivers School of city, state</a></b><br> 1000 Placeholder Road<br> city, state 00000<br> <a href="tel:+18008311300">Phone: (800) 831-1300</a> <span class="show-for-small"><a href="../../truck_school_city_state.php#viewmap" target="_blank">Get Directions</a></span></p>
</div>
<div class="columns small-12 medium-5" style="padding: 0; margin: 0;"><a class="hide-for-small button default round" style="padding: .5em; margin: .5em;" href="../../truck_school_city_state.php#viewmap" target="_blank">Get Directions <i class="fi-arrow-right"></i></a></div></div>
	   </div><!-- end row-->	  		 
	  		 <div class="row">
  	  		...
  	  		<p>Call us at 1-800-831-1300 or fill out the brief form below to submit your information to our CDL Classes admissions center. A Roadmaster representative will review your information and contact you to answer all of your questions and set up a date for you to visit the school location nearest you.</p>
   	  		...
   	  		<div id="form">
					...
					<!-- Organization ID-->	  	  		
		  	  		...
		  	  		<!-- Parent Campaign ID-->
		  	  		 <input name="00Nj00000095OEC" type="hidden" value="Salesforce ID" />  
