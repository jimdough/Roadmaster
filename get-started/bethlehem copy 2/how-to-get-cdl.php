...
<!--Content 1--> 
<div class="row">
	<div class="column small-12 large-12 medium-12 editable">
...
<!--Content 2--> 
	<div class="row">
		<div class="column small-12 large-6 medium-12 editable">
			<div class="panel">
		 ...
		 <div class="large-6 columns editable"> 
	  <div class="panel radius">
	  <h2>Roadmaster teaches you how to get your cdl in Pennsylvania at our CDL License training school.</h2>
	  		  	  	
	  <p>Roadmaster has administrative offices, spacious classrooms, and computer labs where you will attend Pennsylvania CDL license training in Pennsylvania. The school maintains specially designed driving courses where students practice backing, coupling, uncoupling, and docking tractor trailers.</p>
	  ...
	  <p>Roadmaster owns a fleet of late model tractor-trailers used exclusively for student training and provides equipment to teach you how to get your Commercial Driver License (Class A CDL License) testing at all locations.</p>
			  	...
			  	<ul class="yes-bullet">
				  	...
				  	<li>Learn all you need to know how to get your CDL in Pennsylvania</li>
...
<!--Content 3-->
      <div class="row">
  	  <div class="large-6 columns editable">	  	  
	  	  ...
	  	  <p>Becoming a truck driver is possible with the right driver CDL training behind you. With a solid reputation in the field, Roadmaster Drivers School can help show you how to get your CDL license in PA and become a professional truck driver with only 4 weeks of specialized hands-on training. For over 20 years, Roadmaster has trained over 60,000 entry level drivers and continues to help put people to work every day!</p>
